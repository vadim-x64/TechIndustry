...
## 🧠 Теорія
Supervised моделі вчаться на розмічених прикладах і прогнозують цільову змінну. Для класифікації та регресії важливі baseline моделі, інтерпретація та контроль перенавчання. Надто складний алгоритм без стабільного пайплайну не гарантує кращий результат.
...
### Приклад 1
Класифікація: churn prediction через logistic regression або gradient boosting.

### Приклад 2
Регресія: прогноз попиту або виручки на базі історичних ознак.
